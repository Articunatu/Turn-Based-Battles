...
public enum BattleState { Start, ActionSelect, PlayerMove, RunningTurn, Busy, PartyScreen, Switching, BattleOver }
...
public class TurnManager : MonoBehaviour
{
    ...
    [HideInInspector] public int currentMove, currentMember, currentEnemy = 0, opponentAttackSpeed, userAttackSpeed;
